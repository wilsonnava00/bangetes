...
function gestionarDatosUsuario(nuevosDatos) {
  ...
  /**
   * Valida que el input de coe solo acepte valores numéricos y limite su longitud.
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    if (coe) {
      ...
      coe.addEventListener("input", handleTokenInput);
      
      // También validar en eventos de pegado (paste)
      coe.addEventListener("paste", function(e) {
